...
public class FrozenTrailDash : MonoBehaviour
{
    [Tooltip("Prefab del charco de hielo que se spawnea durante el dash")]
    public GameObject trailPrefab;

    [Tooltip("Cuánto dura el charco de hielo en el mundo")]
    ...
    private void Update()
    {
        ...
        // Solo spawnear mientras estamos en el DashState
